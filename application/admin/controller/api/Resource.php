...
{
    //资源列表数据
    public function resourceListApi(ResourceModel $resourceModel, $currentIndex, $pageSize, $pageSize, $type_id = '%', $keywords = '%')
    {
        return $resourceModel->resourceList($currentIndex, $pageSize, $type_id, $keywords);
    }
