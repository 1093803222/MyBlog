<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"F:\halloword\xinleiBlog\public/../application/admin\view\show\_resource\resourceList.html";i:1504923849;}*/ ?>
﻿
<!DOCTYPE html>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="type" lay-filter="type">
                                    ...
                                    <option value="<?php echo $v['id']; ?>"><?php echo $v['resource_type_name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
