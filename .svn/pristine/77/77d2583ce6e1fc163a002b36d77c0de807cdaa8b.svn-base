<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"F:\halloword\xinleiBlog\public/../application/admin\view\show\_article\articleList.html";i:1504923786;}*/ ?>
﻿
<!DOCTYPE html>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="type" lay-filter="type">
                                    ...
                                    <option value="<?php echo $v['id']; ?>"><?php echo $v['article_type_name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
