<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"F:\halloword\xinleiBlog\public/../application/index\view\public\login.html";i:1505392957;}*/ ?>
﻿<!DOCTYPE html>
...
<?php if(isset($_GET['code']) && session('login_type') == 'sina'): ?>
<script src="__index__/js/sina-login.js"></script>
<?php elseif(isset($_GET['code']) && session('login_type') == 'qq'): ?>
