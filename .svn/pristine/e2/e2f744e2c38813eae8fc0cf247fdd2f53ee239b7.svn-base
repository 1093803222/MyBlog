...
use think\Route;
//第三方登陆
Route::rule('login_sina_callback','index/show.BaseController/login_sina_callback');
Route::rule('login','index/show.BaseController/login');
Route::rule('login_qq_callback','index/show.BaseController/login_qq_callback');
Route::rule('sinaLogin','index/show.BaseController/sinaLogin');
Route::rule('qqLogin','index/show.BaseController/qqLogin');
...
//首页文章数据
Route::rule('weatherApi','index/api.Index/weatherApi');
