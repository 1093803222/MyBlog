layui.define(['laypage', 'layer', 'form', 'pagesize'], function (exports) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (index, item) {
                    ...
                    html += '<td><button class="layui-btn layui-btn-small layui-btn-normal" onclick="layui.resourceType.editData(\'' + item.id + '\')"><i class="layui-icon">&#xe642;</i></button></td>';
                    html += '<td><button class="layui-btn layui-btn-small layui-btn-danger" onclick="layui.resourceType.deleteData(\'' + item.id + '\')"><i class="layui-icon">&#xe640;</i></button></td>';
                    html += "</tr>";
    ...
    //添加资源分类
    $('#resource-type-add').click(function () {
        ...
        setTimeout(function () {
            ...
            layer.open({
                ...
                shade: 0.1,
                area: ['500px', '200px'],
                content: 'addResourceType.html' //iframe的url
            });
        }, 200);
    });
    ...
    var resourceType = {
        deleteData: function (id) {
            layer.confirm('确定删除？', {
                ...
                $.ajax({
                    type: 'GET',
                    url: 'resourceTypeDeleteApi/' + id + '.html',
        ...
        editData: function (id) {
            ...
            setTimeout(function () {
                ...
                layer.open({
                    ...
                    shade: 0.1,
                    area: ['500px', '200px'],
                    content: 'editResourceType/' + id + '.html' //iframe的url
                });
            }, 200);
        }
    };
