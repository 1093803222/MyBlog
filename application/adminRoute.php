...
//数据库备份页
Route::rule('SQLbackups', 'admin/show.Sqlbackups/index');
//数据库备份接口
Route::rule('SQLbackupsApi', 'admin/api.Sqlbackups/sqlbackupsApi');
...
//文章评论页
Route::rule('admin-article-comment', 'admin/show.Article/articleCommentList');
//文章评论回复页
Route::rule('articleCommentReply/:id', 'admin/show.Article/articleCommentReply');
//文章评论数据
Route::rule('getCommentDataApi','admin/Api.Article/getCommentDataApi');
//文章评论回复数据
Route::rule('getCommentReplyApi','admin/Api.Article/getCommentReplyApi');
//删除文章评论
Route::rule('deleteCommentApi/:id','admin/Api.Article/deleteCommentApi');
//删除文章评论回复
Route::rule('deleteCommentReplyApi/:id','admin/Api.Article/deleteCommentReplyApi');
...
//留言回复
Route::rule('aboutMessageReply/:id','admin/show.About/aboutMessageReply');
//留言数据
Route::rule('getMessageDataApi','admin/Api.About/getMessageDataApi');
//留言回复数据
Route::rule('getMessageReplyApi','admin/Api.About/getMessageReplyApi');
//删除留言
Route::rule('deleteMessageApi/:id','admin/Api.About/deleteMessageApi');
//删除留言回复
Route::rule('deleteMessageReplyApi/:id','admin/Api.About/deleteMessageReplyApi');
